...
# NUMBER OF HOURS TO COMPLETE: 5.5
# YOUR COLLABORATION STATEMENT(s) I received help from Alycia Wong, Matt Cook, and Benjamin Goldberg (refer to syllabus):
#
# *****************************************

# the ultimate goal is to create a function called areaofatriangle,
...
# where two lines intersect (x and y), a function which
...
import math  # This line allows you to use math functions.
...
def intersectionoftwolines_x(m1, b1, m2, b2):
    ...
    x = (b1-b2)/(m2-m1)  # replace this with your calculation for x
    return x
...
def intersectionoftwolines_y(m1, b1, m2, b2):
    ...
    y = (m1*x) +b1   # replace this with your calculation for y
    return y
...
def distancebetweenpoints(x1, y1, x2, y2):
    ...
    # (x1, y1) and (x2, y2)
    distance = math.sqrt(((x2-x1)**2)+((y2-y1)**2))  # replace with
    return distance
...
def heronsformula(a, b, c):
    ...
    area = math.sqrt(s*(s-a)*(s-b)*(s-c))  # replace this
    return area
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    a = distancebetweenpoints(intersectionx1, intersectiony1, intersectionx2, intersectiony2)
    b = distancebetweenpoints(intersectionx2, intersectiony2, intersectionx3, intersectiony3)
    c = distancebetweenpoints(intersectionx3, intersectiony3,intersectionx1, intersectiony1)
